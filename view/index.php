...
<body id="page-home">
  ...
  <header class="banner" id="main-header">
    <div class="header-content" id="header-content">
        ...
        <form action="index.php" method="GET" class="search-form" id="form-busca-global">
            <input type="text" name="busca" id="input-busca" placeholder="Buscar..." value="<?php echo isset($_GET['busca']) ? htmlspecialchars($_GET['busca']) : ''; ?>" required>
  ...
  <?php
      ...
      if (isset($_GET['busca']) && !empty($_GET['busca'])) {
          $termo = $_GET['busca'];
          $consulta = $controller->buscarPorNome($termo);
          $titulo = "Resultados para: " . htmlspecialchars($termo);
          $linkLimpar = " <a href='index.php' id='link-limpar-filtro' style='color:red; font-size:14px; text-decoration:none;'>(✖ Limpar Filtro)</a>";
      } else {
          $consulta = $controller->consulta();
          $titulo = "Todos os Produtos";
          $linkLimpar = "";
      }
  ?>

  <h1 id="titulo-pagina"><?php echo $titulo . $linkLimpar; ?></h1>
  ...
  <div class="container" id="grid-produtos">
    <?php
        if (!is_array($consulta) || count($consulta) == 0) {
            echo "<p id='msg-sem-produtos' style='grid-column: 1/-1; text-align: center; color: #666;'>Nenhum produto encontrado.</p>";
        } else {
